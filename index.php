 ...
 <div class="panel-body">
      <div class="box box-info">
            <div class="box-body">
                    <div class="col-sm-6">
                      <div  align="center"> <img alt="User Pic" src="<?php if(isset($r['profilepic']) & !empty($r['profilepic'])){ echo $r['profilepic']; }else{ echo "https://x1.xingassets.com/assets/frontend_minified/img/users/nobody_m.original.jpg";} ?>" id="profileimage" class="img-circle img-responsive">
                        <div style="color:#999;" ><?php echo $r['ne']; ?></div><!-- Pic Nche name-->
            ...
            <div class="col-sm-6">
              ...
              <span><p><?php echo $r['email']; ?></p></span><!-- Pic Nche name-->
              <span><button type='button' class='btn btn-success'>Active</button><a href="edit-profile.php" class="btn btn-primary col-md-offset-3">Edit</a></span>
            </div>
